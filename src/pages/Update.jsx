...
//  eslint-disable-next-line
  ...
  <h1 className='text-center'>Update Post</h1>
   {postData && <div className='w-50 p-3 mx-auto'>
      <form>
  <div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="description" value={postData?.description} onChange={(e)=>{SetPostData({...postData,description : e.target.value})}}/>
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputPassword1" className="form-label">Content</label>
    <input type="text" className="form-control" id="content" value={postData?.content} onChange={(e)=>{SetPostData({...postData,content : e.target.value})}}/>
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputPassword1" className="form-label">Author</label>
    <input type="text" className="form-control" id="author" value={postData?.author} onChange={(e)=>{SetPostData({...postData,author : e.target.value})}} />
  </div>
  <div className='mb-3'>
